      ...
      <div className="steam-container">
        <div className="steam-content">
          <div className="steam-text">
            <div className="steam-logo-header">
              <span className="steam-badge">Available to wishlist</span>
              <h2 className="section-title">On Steam</h2>
            </div>
          ...
          <div className="steam-visual">
            <div className="steam-visual-placeholder">
              <img
                src="https://cdn.discordapp.com/attachments/1213077013896896552/1453359352718163988/image.png?ex=694d29df&is=694bd85f&hm=3b8ec50cb2209b28de3f6c891df3903d6cd3031dd02bf75b5b0b04241caa862b&"
                alt="Steam Store"
              />
            </div>
          </div>
